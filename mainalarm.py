...
Menubar.add_command(label="Set Alarm Music ",command=load_music,font=('Technolog', 3, ' bold '))
...
lbl0=Label(root,font=('Helvetica', 22, ' bold '),background="black",foreground="red")
...
defulte_song="C:\\Program Files\\alarm\\songs\\mixkit-city-alert-siren-loop-1008.mp3"
songs=[]
